...
public class employee_salary {
	...
	public static void define_data_type() {
		...
		try {
			...
			if(!employee_detail.equals("")) {
				...
				// weekly rate ni employee multiply by 8 * 7
	...
	public static String get_compensation_calculation() {
		...
		System.out.println("Salary Per Day: "+per_day);
		
		double per_week = salary_per_week  ;
		System.out.println("Weekly Salary: "+per_week);
		
		double basicSalary_per_week = (per_week); // Basic weekly salary
		double totalSalary = basicSalary_per_week;
		
		double deductedSalary_per_week = (per_week); // Deducted weekly salary
		double totaldeductedSalary = deductedSalary_per_week;
		...
		if (Integer.parseInt(d_monthly_salary) >= 60000 && Integer.parseInt(d_monthly_salary) <= 90000) {
		    ...
		    System.out.println("Rice Subsidy:" + 1500/4);
			System.out.println("Phone Allowance:" + 2000/4);
			System.out.println("Clothing Allowance:" + 1000/4);
		System.out.println("Total Weekly Compensation: " + totalSalary);}
		...
		if (Integer.parseInt(d_monthly_salary) >= 50825 && Integer.parseInt(d_monthly_salary) <= 53500) {
		    ...
		    System.out.println("Compensation:");
		    System.out.println("Rice Subsidy:" + 1500/4);
			System.out.println("Phone Allowance:" + 1000/4);
			System.out.println("Clothing Allowance:" + 1000/4);
		System.out.println("Total Weekly Compensation: " + totalSalary);}
		...
		if (Integer.parseInt(d_monthly_salary) >= 38475 && Integer.parseInt(d_monthly_salary) <= 42975) {
		    ...
		    System.out.println("Compensation:");
		    System.out.println("Rice Subsidy:" + 1500/4);
			System.out.println("Phone Allowance:" + 800/4);
			System.out.println("Clothing Allowance:" + 800/4);
		System.out.println("Total Weekly Compensation: " + totalSalary);}
		...
		if (Integer.parseInt(d_monthly_salary) >= 22500 && Integer.parseInt(d_monthly_salary) <= 24000) {
		    ...
		    System.out.println("Compensation:");
			System.out.println("Rice Subsidy: +"+1500/4);
			System.out.println("Phone Allowance: +"+500/4);
			System.out.println("Clothing Allowance: +"+500/4); 
		    System.out.println("Total Weekly Compensation: " + totalSalary);}
		...
		// Pag-ibig = 2%
			...
			System.out.println("SSS: -"+deduction_SSS);
			System.out.println("Philhealth: -"+deductionPhilhealth);
			System.out.println("Pagibig: -"+deductionPagibig);
			System.out.println("Total Weekly Deduction:"+(deduction_SSS+deductionPhilhealth+deductionPagibig));

			System.out.println("-----------------");
			System.out.println("Net Weekly Pay: " + (totalSalary - deductionSSS - deductionPhilhealth - deductionPagibig));
		}
